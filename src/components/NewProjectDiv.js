...
export default function NewProjectDiv(props) {
  ...
  return (
    <div className="new-project flex gap-1 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 mx-auto max-w-md px-10 py-5 space-y-5 border border-gray-300 bg-white z-10">
      <div>
        {error && <div>{error}</div>}
